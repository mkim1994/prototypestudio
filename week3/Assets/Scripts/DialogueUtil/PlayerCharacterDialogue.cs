...
public class PlayerCharacterDialogue : MonoBehaviour
{
    ...
    {
        var allParticipants = new List<NPCDialogue>(FindObjectsOfType<NPCDialogue>());
        var target = allParticipants.Find(delegate (NPCDialogue p)
        {
