Konserian Highlands artwork set,
...
file or set the models up again in the ingame editor.
...
Also added the screenshots used for making the skybox and the heightmap and layer masks for creating the terrain where I
took the screenshots for the skybox, so if you want to create another version of the skybox, this may be useful.
...
all in game ready and source file version

----------------------

Credits:

Textures based mostly on public domain textures provided by nobiax http://nobiax.deviantart.com/ and from http://www.burningwell.org
